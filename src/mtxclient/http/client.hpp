...
#ifndef MTXCLIENT_HTTP_CLIENT_HPP
#define MTXCLIENT_HTTP_CLIENT_HPP
...
template <class Request, class Response>
void mtx::http::Client::post(const std::string &endpoint,
                             const Request &req,
...
// put function for the PUT HTTP requests that send responses
template <class Request, class Response>
void mtx::http::Client::put(const std::string &endpoint,
                            const Request &req,
                            Callback<Response> callback,
                            bool requires_auth)
{
...
template <class Response>
void mtx::http::Client::get(const std::string &endpoint,
...
template <class Payload, mtx::events::EventType Event>
void mtx::http::Client::send_room_message(const std::string &room_id,
                                          const Payload &payload,
...
template <class Payload, mtx::events::EventType Event>
void mtx::http::Client::send_state_event(const std::string &room_id,
                                         const std::string &state_key,
                                         const Payload &payload,
                                         Callback<mtx::responses::EventId> callback)
{
